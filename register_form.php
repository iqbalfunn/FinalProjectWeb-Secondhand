                ...
                <div class="container-fluid">
						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
                                    ...
                                    <div class="form-group">
                                        <input class="input form-control input-borders" type="text" name="alamat" id="alamat" placeholder="Alamat">
                                    </div>
                                    <div class="form-group">
                                        <input class="input form-control input-borders" type="text" name="kota" id="kota" placeholder="Kota">
                                    </div>
